...
(async()=>{
 ...
 await pg.goto('http://localhost:3200/',{waitUntil:'load',timeout:60000});
 await pg.waitForTimeout(1500);
 await pg.screenshot({path:out+'/home-desktop.png',fullPage:true});
 console.log('OK home-desktop');
 await pg.goto('http://localhost:3200/listings',{waitUntil:'load',timeout:60000});
 await pg.waitForTimeout(1500);
 ...
 await m.goto('http://localhost:3200/',{waitUntil:'load',timeout:60000});
